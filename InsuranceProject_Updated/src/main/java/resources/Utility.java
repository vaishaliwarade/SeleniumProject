...
public class Utility {
	...
	public static WebDriver geturl() throws IOException
	{
		...
		FileInputStream input = new FileInputStream(System.getProperty("user.dir")+"\\src\\main\\java\\Global.properties");		
		Properties p = new Properties();
		p.load(input);
		
		//driver.get((String) p.get("url"));
...
*/	
	...
	//screenshot for failure testcases
